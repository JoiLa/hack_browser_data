...
func (b *Bookmarks) Get() interface{} {
	return b.bookmarks
}

type CookieSource map[string][]cookie
...
func (c *Cookies) Get() interface{} {
	return c.cookies
}

type HistoryDataSource []history
...
func (h *HistoryData) Get() interface{} {
	return h.history
}

type DownloadSource []download
...
func (d *Downloads) Get() interface{} {
	return d.downloads
}

type LoginSource []loginData
...
func (p *Passwords) Get() interface{} {
	return p.logins
}

type CreditCardSource map[string][]card

type CreditCards struct {
	mainPath string
	cards    CreditCardSource
}
...
func (c *CreditCards) Get() interface{} {
	return c.cards
}
